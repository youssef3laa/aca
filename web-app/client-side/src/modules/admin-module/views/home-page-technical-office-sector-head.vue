<template>
    <v-container class="fill-height">
        ...
        <Topbar :val="{ tasks: taskList }"></Topbar>
         <TechnicalOfficeSectorHeadInbox></TechnicalOfficeSectorHeadInbox>
...
<script>
    ...
    import TechnicalOfficeSectorHeadInbox from "../../application-builder-module/components/technical-office-sector-head-inbox"
    import userMixin from '../../../mixins/userMixin'
    import Topbar from "../../application-builder-module/components/topbar-component";
    export default {
        name: "HomePageTechnicalOfficeSectorHead",
        components: {
            TechnicalOfficeSectorHeadInbox,
            Charts, Topbar
        },
